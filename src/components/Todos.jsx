        ...
        {todos.map((todo) => (
          ...
          >
            {isEditing === todo.id ? (
              ...
              <>
              <span style={{ textDecoration: todo.completed ? 'line-through' : 'none' }} className='text-white'>
                <div className='text-white'>{todo.text}</div></span>
                <button
                ...
                <button
                  ...
                  className="ml-2 text-white bg-yellow-500 border-0 py-1 px-4 focus:outline-none hover:bg-yellow-600 rounded text-md"
                >
                  Edit
                </button>
                <button
